...
export const EXAM_2018_REAL: ExamData = {
  ...
  questions: [
    ...
    // ── Q10 (Q30) ───────────────────────────────────────────
    {
      ...
      visualization: {
        type: 'urn-tree',
        title: 'Bag with 3 red, 3 green, 1 white — 2 draws with replacement',
        description: 'All 9 possible outcomes shown. Favorable cases (same color) are highlighted in green.',
        balls: [
          { color: '#E84C4C', label: 'Red', count: 3 },
          { color: '#4CE87C', label: 'Green', count: 3 },
          { color: '#F5F0E8', label: 'White', count: 1 },
        ],
