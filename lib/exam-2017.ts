// ============================================================
// Real Exam Data – UM6SS Medical Entrance Exam 2017
// Mathematics Paper — Academic Year 2017-2018 (taken summer 2017)
// 15 QCM (Q46-Q60), pharmacy track — year inferred from chronological pattern
// (the year 2018 slot was reassigned to the dated July 2018 medicine paper)
// ============================================================

import type { ExamData } from './exam-data'

export const EXAM_2017_REAL: ExamData = {
  year: 2017,
  date: 'Summer 2017 — Academic Year 2017-2018',
  duration: 30,
  categoryId: 'real-exam',
  correctionLocked: true,
  title: `Common Entrance Exam for Pharmaceutical Studies — Academic Year 2017-2018`,
